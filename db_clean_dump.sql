...
ALTER TABLE IF EXISTS ONLY elly.component_forms
DROP CONSTRAINT IF EXISTS fkr7eas7bmrp0oy59xx18r2btgv;

ALTER TABLE IF EXISTS ONLY elly.widget_banners
DROP CONSTRAINT IF EXISTS fkqp8ibilv4fv8pywrgn1h847op;

ALTER TABLE IF EXISTS ONLY elly.cms_contents
DROP CONSTRAINT IF EXISTS fko0xv9diurwi1ltwbceg7t694c;

ALTER TABLE IF EXISTS ONLY elly.component_forms
DROP CONSTRAINT IF EXISTS fknlk3jjp9ybylq5ra6x1ygjj8a;

ALTER TABLE IF EXISTS ONLY elly.widget_banners
DROP CONSTRAINT IF EXISTS fklsci7uxy4fqqj23t52huyis42;

ALTER TABLE IF EXISTS ONLY elly.pages
DROP CONSTRAINT IF EXISTS fkl9l1wjycqrl62d4r8jn3u4nu5;

ALTER TABLE IF EXISTS ONLY elly.ratings
DROP CONSTRAINT IF EXISTS fkl38egjrojmh8hq3uoyo7is8h6;

ALTER TABLE IF EXISTS ONLY elly.page_components
DROP CONSTRAINT IF EXISTS fkk0cqx20neichlg97egj3jgqg0;

ALTER TABLE IF EXISTS ONLY elly.comments
DROP CONSTRAINT IF EXISTS fkh4c7lvsc298whoyd4w9ta25cr;

ALTER TABLE IF EXISTS ONLY elly.page_components
DROP CONSTRAINT IF EXISTS fkdfob1d9oq7vfmb8o67n27vohg;

ALTER TABLE IF EXISTS ONLY elly.component_banners
DROP CONSTRAINT IF EXISTS fkcnj5y54vcky4w0ww2gvt87y7g;

ALTER TABLE IF EXISTS ONLY elly.component_widgets
DROP CONSTRAINT IF EXISTS fkcenu7fw3b2eo8pv0oo48hqunc;

ALTER TABLE IF EXISTS ONLY elly.component_widgets
DROP CONSTRAINT IF EXISTS fkc2i9net1t9vlm4dmbcm5mlcsj;

ALTER TABLE IF EXISTS ONLY elly.posts
DROP CONSTRAINT IF EXISTS fkb7fka510air19xqvbxtod9ht0;

ALTER TABLE IF EXISTS ONLY elly.widget_posts
DROP CONSTRAINT IF EXISTS fka8ax06lro5qx37mv5yo08l1ck;

ALTER TABLE IF EXISTS ONLY elly.comments
DROP CONSTRAINT IF EXISTS fk7h839m3lkvhbyv3bcdv7sm4fj;

ALTER TABLE IF EXISTS ONLY elly.component_banners
DROP CONSTRAINT IF EXISTS fk5pb7bbbtpn4722qh2d75mlpnx;

ALTER TABLE IF EXISTS ONLY elly.widget_posts
DROP CONSTRAINT IF EXISTS fk3ssrfk5po43ldy0rtd0jmx1a8;

ALTER TABLE IF EXISTS ONLY elly.form_submissions
DROP CONSTRAINT IF EXISTS fk2kxl75gxcdqrjh4n9k5qo27q8;

ALTER TABLE IF EXISTS ONLY elly.refresh_tokens
...
ALTER TABLE IF EXISTS ONLY elly.widgets
DROP CONSTRAINT IF EXISTS widgets_pkey;

ALTER TABLE IF EXISTS ONLY elly.widget_posts
DROP CONSTRAINT IF EXISTS widget_posts_pkey;

ALTER TABLE IF EXISTS ONLY elly.widget_banners
DROP CONSTRAINT IF EXISTS widget_banners_pkey;

ALTER TABLE IF EXISTS ONLY elly.users
DROP CONSTRAINT IF EXISTS users_pkey;

ALTER TABLE IF EXISTS ONLY elly.pages
DROP CONSTRAINT IF EXISTS ukop7mbivq89lx29uoeta2o6hc1;

ALTER TABLE IF EXISTS ONLY elly.posts
DROP CONSTRAINT IF EXISTS ukml7eiucwpy3gkvs30195gvmdl;

ALTER TABLE IF EXISTS ONLY elly.assets
DROP CONSTRAINT IF EXISTS ukln4kj492rlnemwox5b7x38ld7;
...
ALTER TABLE IF EXISTS ONLY elly.ratings
DROP CONSTRAINT IF EXISTS uc_rating_user_post;

ALTER TABLE IF EXISTS ONLY elly.posts
DROP CONSTRAINT IF EXISTS uc_post_slug;

ALTER TABLE IF EXISTS ONLY elly.pages
DROP CONSTRAINT IF EXISTS uc_page_slug;

ALTER TABLE IF EXISTS ONLY elly.seo_infos
DROP CONSTRAINT IF EXISTS seo_infos_pkey;
...
ALTER TABLE IF EXISTS ONLY elly.pages
DROP CONSTRAINT IF EXISTS pages_pkey;

ALTER TABLE IF EXISTS ONLY elly.page_components
DROP CONSTRAINT IF EXISTS page_components_pkey;
...
ALTER TABLE IF EXISTS ONLY elly.refresh_tokens
DROP CONSTRAINT IF EXISTS idx_refresh_token_token;

ALTER TABLE IF EXISTS ONLY elly.posts
DROP CONSTRAINT IF EXISTS idx_post_slug;

ALTER TABLE IF EXISTS ONLY elly.pages
DROP CONSTRAINT IF EXISTS id_page_page_slug;

ALTER TABLE IF EXISTS ONLY elly.form_submissions
DROP CONSTRAINT IF EXISTS form_submissions_pkey;

ALTER TABLE IF EXISTS ONLY elly.form_definitions
DROP CONSTRAINT IF EXISTS form_definitions_pkey;

ALTER TABLE IF EXISTS ONLY elly.email_logs
DROP CONSTRAINT IF EXISTS email_logs_pkey;

ALTER TABLE IF EXISTS ONLY elly.components
DROP CONSTRAINT IF EXISTS components_pkey;

ALTER TABLE IF EXISTS ONLY elly.component_widgets
DROP CONSTRAINT IF EXISTS component_widgets_pkey;

ALTER TABLE IF EXISTS ONLY elly.component_forms
DROP CONSTRAINT IF EXISTS component_forms_pkey;

ALTER TABLE IF EXISTS ONLY elly.component_banners
DROP CONSTRAINT IF EXISTS component_banners_pkey;

ALTER TABLE IF EXISTS ONLY elly.comments
DROP CONSTRAINT IF EXISTS comments_pkey;

ALTER TABLE IF EXISTS ONLY elly.cms_contents
DROP CONSTRAINT IF EXISTS cms_contents_pkey;

ALTER TABLE IF EXISTS ONLY elly.cms_basic_infos
DROP CONSTRAINT IF EXISTS cms_basic_infos_pkey;

ALTER TABLE IF EXISTS ONLY elly.banners
DROP CONSTRAINT IF EXISTS banners_pkey;
...
ALTER TABLE elly.assets
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.assets_id_seq START
    WITH
...
ALTER TABLE elly.banners
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.banners_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE elly.comments
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.comments_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
CREATE TABLE elly.components (
    ...
    type smallint,
    CONSTRAINT components_type_check CHECK (
        (
            (type >= 0)
            AND (type <= 1)
        )
...
ALTER TABLE elly.components
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.components_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE elly.email_logs
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.email_logs_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE elly.form_definitions
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.form_definitions_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE elly.form_submissions
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.form_submissions_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE elly.pages
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.pages_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE elly.posts
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.posts_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE elly.ratings
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.ratings_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE elly.refresh_tokens
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.refresh_tokens_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE elly.seo_infos
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.seo_infos_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE elly.users
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.users_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE elly.widgets
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME elly.widgets_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
1	2026-01-25 01:12:26.153	2026-01-25 01:12:26.153	https://www.huseyindol.com/ana-sayfa	Ana Sayfa SEO Meta Açıklama	Ana Sayfa SEO Meta Açıklama,Ana Sayfa SEO Meta Açıklama,Ana Sayfa SEO Meta Açıklama	f	f	Ana Sayfa SEO Başlığı
2	2026-01-25 01:20:28.804	2026-01-25 01:20:28.804	https://www.huseyindol.com/deneme-post	deneme post aciklama	deneme, post, aciklama	f	f	deneme post
\.
...
COPY elly.widget_posts (widget_id, post_id) FROM stdin; 1 1 \.
...
ADD CONSTRAINT component_forms_pkey PRIMARY KEY (
    component_id,
    form_definition_id
);
