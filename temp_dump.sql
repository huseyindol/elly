...
\restrict UxtKm8RdhlEO0wIbjciZUMoyxH56NZPqfjIl5b5A6qQd1qaa5Ci8NKpPqu65LK7
...
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.assets_id_seq START
    WITH
...
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.banners_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
CREATE TABLE public.cms_basic_infos (
    id uuid NOT NULL,
    created_at timestamp(6) without time zone,
...
ALTER TABLE public.cms_basic_infos OWNER TO postgres;
...
CREATE TABLE public.component_banners (
    component_id bigint NOT NULL,
    banner_id bigint NOT NULL
);

ALTER TABLE public.component_banners OWNER TO postgres;

--
-- Name: component_forms; Type: TABLE; Schema: elly; Owner: postgres
--

CREATE TABLE public.component_forms (
    component_id bigint NOT NULL,
    form_definition_id bigint NOT NULL
);

ALTER TABLE public.component_forms OWNER TO postgres;
...
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.components_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.email_logs_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.form_definitions_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.form_submissions_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE public.page_components OWNER TO postgres;
...
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.pages_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.posts_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.ratings_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.refresh_tokens_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
ALTER TABLE public.seo_infos OWNER TO postgres;

--
-- Name: seo_infos_id_seq; Type: SEQUENCE; Schema: elly; Owner: postgres
--

ALTER TABLE public.seo_infos
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.seo_infos_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
CREATE TABLE public.widget_banners (
    widget_id bigint NOT NULL,
    banner_id bigint NOT NULL
);

ALTER TABLE public.widget_banners OWNER TO postgres;

--
-- Name: widget_posts; Type: TABLE; Schema: elly; Owner: postgres
--

CREATE TABLE public.widget_posts (
    widget_id bigint NOT NULL,
    post_id bigint NOT NULL
);

ALTER TABLE public.widget_posts OWNER TO postgres;
...
ALTER COLUMN id
ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.widgets_id_seq START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);
...
COPY public.assets (id, created_at, updated_at, extension, name, path, sub_folder, type) FROM stdin;
...
COPY public.banners (id, created_at, updated_at, alt_text, desktop, mobile, tablet, link, order_index, status, sub_folder, target, title, type) FROM stdin;
...
COPY public.cms_basic_infos (id, created_at, description, is_active, section_key, sort_order, title, updated_at) FROM stdin;
...
COPY public.cms_contents (id, content_type, created_at, metadata, updated_at, basic_info_id, description, is_active, section_key, sort_order, title) FROM stdin;
...
COPY public.comments (id, created_at, updated_at, content, email, name, status, parent_comment_id, post_id) FROM stdin;
\.
...
COPY public.component_banners (component_id, banner_id) FROM stdin;
2	1
2	2
\.
...
COPY public.component_forms (component_id, form_definition_id) FROM stdin;
\.
...
COPY public.component_widgets (component_id, widget_id) FROM stdin;
1	1
3	2
\.
...
COPY public.components (id, created_at, updated_at, content, description, name, order_index, status, template, type) FROM stdin;
...
COPY public.email_logs (id, created_at, updated_at, error_message, payload_json, recipient, retry_count, sent_at, status, subject, template_name) FROM stdin;
...
COPY public.form_definitions (id, created_at, updated_at, active, schema, title, version) FROM stdin;
...
COPY public.form_submissions (id, created_at, updated_at, payload, submitted_at, form_definition_id) FROM stdin;
...
COPY public.page_components (page_id, component_id) FROM stdin;
1	1
1	2
1	3
\.
...
COPY public.pages (id, created_at, updated_at, description, slug, status, template, title, seo_info_id) FROM stdin;
...
COPY public.posts (id, created_at, updated_at, content, order_index, slug, status, template, title, seo_info_id) FROM stdin;
...
COPY public.ratings (id, created_at, updated_at, comment, rating, user_identifier, post_id) FROM stdin;
\.
...
COPY public.refresh_tokens (id, created_at, updated_at, expiry_date, is_revoked, token, user_id) FROM stdin;
...
COPY public.seo_infos (id, created_at, updated_at, canonical_url, description, keywords, no_follow, no_index, title) FROM stdin;
...
COPY public.users (id, created_at, updated_at, email, first_name, is_active, last_name, password, provider, provider_id, token_version, username) FROM stdin;
...
COPY public.widget_banners (widget_id, banner_id) FROM stdin;
2	1
2	2
\.
...
COPY public.widget_posts (widget_id, post_id) FROM stdin; 1 1 \.
...
COPY public.widgets (id, created_at, updated_at, content, description, name, order_index, status, template, type) FROM stdin;
...
SELECT pg_catalog.setval ( 'public.assets_id_seq', 28, true );
...
SELECT pg_catalog.setval ( 'public.form_definitions_id_seq', 2, true );

--
-- Name: form_submissions_id_seq; Type: SEQUENCE SET; Schema: elly; Owner: postgres
--

SELECT pg_catalog.setval ( 'public.form_submissions_id_seq', 4, true );
...
SELECT pg_catalog.setval ( 'public.seo_infos_id_seq', 2, true );
...
ALTER TABLE ONLY public.cms_basic_infos
...
ALTER TABLE ONLY public.component_banners
...
ALTER TABLE ONLY public.component_forms
...
ALTER TABLE ONLY public.component_widgets
...
ALTER TABLE ONLY public.seo_infos
...
ALTER TABLE ONLY public.widget_banners
...
ALTER TABLE ONLY public.widget_posts
...
CREATE INDEX id_banner_status ON public.banners USING btree (status);

--
-- Name: id_banner_title; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_banner_title ON public.banners USING btree (title);

--
-- Name: id_component_name; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_component_name ON public.components USING btree (name);

--
-- Name: id_component_type; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_component_type ON public.components USING btree (type);

--
-- Name: id_component_type_name; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_component_type_name ON public.components USING btree (type, name);

--
-- Name: id_component_type_status; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_component_type_status ON public.components USING btree (type, status);

--
-- Name: id_page_status; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_page_status ON public.pages USING btree (status);

--
-- Name: id_seoinfo_canonical_url; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_seoinfo_canonical_url ON public.seo_infos USING btree (canonical_url);

--
-- Name: id_seoinfo_title; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_seoinfo_title ON public.seo_infos USING btree (title);

--
-- Name: id_widget_name; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_widget_name ON public.widgets USING btree (name);

--
-- Name: id_widget_type; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_widget_type ON public.widgets USING btree (type);

--
-- Name: id_widget_type_name; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_widget_type_name ON public.widgets USING btree (type, name);

--
-- Name: id_widget_type_status; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX id_widget_type_status ON public.widgets USING btree (type, status);

--
-- Name: idx_cms_basic_info_active; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_cms_basic_info_active ON public.cms_basic_infos USING btree (is_active);

--
-- Name: idx_cms_basic_info_section_key; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_cms_basic_info_section_key ON public.cms_basic_infos USING btree (section_key);

--
-- Name: idx_cms_content_active; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_cms_content_active ON public.cms_contents USING btree (is_active);

--
-- Name: idx_cms_content_content_type; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_cms_content_content_type ON public.cms_contents USING btree (content_type);

--
-- Name: idx_cms_content_section_key; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_cms_content_section_key ON public.cms_contents USING btree (section_key);
...
CREATE INDEX idx_comment_post_id ON public.comments USING btree (post_id);

--
-- Name: idx_comment_post_status; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_comment_post_status ON public.comments USING btree (post_id, status);

--
-- Name: idx_comment_status; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_comment_status ON public.comments USING btree (status);
...
CREATE INDEX idx_email_status_created ON public.email_logs USING btree (status, created_at);

--
-- Name: idx_form_def_active; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_form_def_active ON public.form_definitions USING btree (active);

--
-- Name: idx_form_def_title; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_form_def_title ON public.form_definitions USING btree (title);

--
-- Name: idx_form_sub_form_id; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_form_sub_form_id ON public.form_submissions USING btree (form_definition_id);

--
-- Name: idx_form_sub_submitted_at; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_form_sub_submitted_at ON public.form_submissions USING btree (submitted_at);

--
-- Name: idx_post_seo_info_id; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_post_seo_info_id ON public.posts USING btree (seo_info_id);
...
CREATE INDEX idx_rating_post_id ON public.ratings USING btree (post_id);

--
-- Name: idx_rating_user_post; Type: INDEX; Schema: elly; Owner: postgres
--

CREATE INDEX idx_rating_user_post ON public.ratings USING btree (user_identifier, post_id);
...
ALTER TABLE ONLY public.form_submissions
ADD CONSTRAINT fk2kxl75gxcdqrjh4n9k5qo27q8 FOREIGN KEY (form_definition_id) REFERENCES public.form_definitions (id);
...
ALTER TABLE ONLY public.widget_posts
ADD CONSTRAINT fk3ssrfk5po43ldy0rtd0jmx1a8 FOREIGN KEY (post_id) REFERENCES public.posts (id);
...
ALTER TABLE ONLY public.component_banners
ADD CONSTRAINT fk5pb7bbbtpn4722qh2d75mlpnx FOREIGN KEY (banner_id) REFERENCES public.banners (id);
...
ALTER TABLE ONLY public.widget_posts
ADD CONSTRAINT fka8ax06lro5qx37mv5yo08l1ck FOREIGN KEY (widget_id) REFERENCES public.widgets (id);
...
ALTER TABLE ONLY public.posts
ADD CONSTRAINT fkb7fka510air19xqvbxtod9ht0 FOREIGN KEY (seo_info_id) REFERENCES public.seo_infos (id);
...
ALTER TABLE ONLY public.component_widgets
ADD CONSTRAINT fkc2i9net1t9vlm4dmbcm5mlcsj FOREIGN KEY (component_id) REFERENCES public.components (id);
...
ALTER TABLE ONLY public.component_widgets
ADD CONSTRAINT fkcenu7fw3b2eo8pv0oo48hqunc FOREIGN KEY (widget_id) REFERENCES public.widgets (id);
...
ALTER TABLE ONLY public.component_banners
ADD CONSTRAINT fkcnj5y54vcky4w0ww2gvt87y7g FOREIGN KEY (component_id) REFERENCES public.components (id);
...
ALTER TABLE ONLY public.page_components
ADD CONSTRAINT fkdfob1d9oq7vfmb8o67n27vohg FOREIGN KEY (component_id) REFERENCES public.components (id);
...
ALTER TABLE ONLY public.page_components
ADD CONSTRAINT fkk0cqx20neichlg97egj3jgqg0 FOREIGN KEY (page_id) REFERENCES public.pages (id);
...
ALTER TABLE ONLY public.ratings
ADD CONSTRAINT fkl38egjrojmh8hq3uoyo7is8h6 FOREIGN KEY (post_id) REFERENCES public.posts (id);
...
ALTER TABLE ONLY public.pages
ADD CONSTRAINT fkl9l1wjycqrl62d4r8jn3u4nu5 FOREIGN KEY (seo_info_id) REFERENCES public.seo_infos (id);
...
ALTER TABLE ONLY public.widget_banners
ADD CONSTRAINT fklsci7uxy4fqqj23t52huyis42 FOREIGN KEY (widget_id) REFERENCES public.widgets (id);
...
ALTER TABLE ONLY public.component_forms
ADD CONSTRAINT fknlk3jjp9ybylq5ra6x1ygjj8a FOREIGN KEY (component_id) REFERENCES public.components (id);
...
ALTER TABLE ONLY public.cms_contents
ADD CONSTRAINT fko0xv9diurwi1ltwbceg7t694c FOREIGN KEY (basic_info_id) REFERENCES public.cms_basic_infos (id);
...
ALTER TABLE ONLY public.widget_banners
ADD CONSTRAINT fkqp8ibilv4fv8pywrgn1h847op FOREIGN KEY (banner_id) REFERENCES public.banners (id);
...
ALTER TABLE ONLY public.component_forms
ADD CONSTRAINT fkr7eas7bmrp0oy59xx18r2btgv FOREIGN KEY (form_definition_id) REFERENCES public.form_definitions (id);

--
-- PostgreSQL database dump complete
--

\unrestrict UxtKm8RdhlEO0wIbjciZUMoyxH56NZPqfjIl5b5A6qQd1qaa5Ci8NKpPqu65LK7